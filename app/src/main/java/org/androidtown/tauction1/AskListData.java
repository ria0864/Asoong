...
public class AskListData {
    ...
    public AskListData(int image_region, int ask_no, int reg_no, int done, Date ask_startday, Date ask_endday, int ask_budget, int ask_num, String mem_id, int ask_commentNo) {
